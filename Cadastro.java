...
public class Cadastro {
    ...
    public Cadastro(){
        ...
        categorias.put(1,new Categoria(1, "Disponivel"));
        categorias.put(2,new Categoria(2,"Disponivel"));
        categorias.put(3,new Categoria(3,"Disponivel"));
        categorias.put(4,new Categoria(4,"Disponivel"));
    }
    ...
    public void alterarProduto(){
        ...
        if (produtoExistente != null) {
            ...
            Produto novoProduto = new Produto(codigo, nome, preco, categoria);
